...
/*
    ...
    - implementing "dead letters" - receives any messages that don't have a valid destination
    - uniquely identifying actors by their "path": /parent/child/grandchild/...
    - handling failures inside actors
    - adding richer APIs
        - routers for work distribution
        - interaction patterns: forwarding messages, expecting replies, backoff retries
        - timed messages & schedulers
    - configuration: mailbox sizes, dispatchers
 */
